...
describe "#translate" do
  ...
  it "retains punctuation" do
    s = translate("This veritable glut? How Squarely obsequious perspicacious, to have predicted it.")
    s.should == "Isthay eritablevay utglay? Owhay Arelysquay obsequiousay erspicaciouspay, otay avehay edictedpray itay."
  end
  # Test-driving bonus:
