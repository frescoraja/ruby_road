...
describe Fixnum do
  ...
  it "reads thousands" do
    ...
    99999.in_words.should == 'ninety nine thousand nine hundred ninety nine'
  end

  it "reads millions" do
    10_000_001.in_words.should == 'ten million one'
    9_345_122.in_words.should == 'nine million three hundred forty five thousand one hundred twenty two'
  end
